...
{
    // Register NSUser Defaults
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    NSDictionary *defaultDictionary = [NSDictionary dictionaryWithObjectsAndKeys:
                                       [NSString stringWithFormat:@"Moscow,ID"],@"UserLocation",  // default zipcode
                                       [NSNumber numberWithBool:YES],@"UnitsOfMeasure",  // 0 = USA 1 = metric
                                       [NSNumber numberWithBool:YES],@"PlaySFX", // Yes plays sfx, NO is silent
                                       nil];
    [defaults registerDefaults:defaultDictionary];
    NSLog(@" *** DEFAULTS *** \nLOC:%@ SFX:%i",[defaults stringForKey:@"UserLocation"],[defaults boolForKey:@"PlaySFX"]);
